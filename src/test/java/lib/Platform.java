...
public class Platform {
    ...
    private static Platform instance;                               //приватный конструктор
    private Platform() {}                                           //приватный конструктор
    public static Platform getInstance()                            //используем метод getInstance для вызова Platform
    {
        if (instance == null) {
    ...
    private ChromeOptions getMWChromeOptions()
    {
        ...
        mobileEmulation.put("userAgent", "Mozilla/5.0 (Linux; Android 4.2.1; en-us; Nexus 5 Build/JOP40D) AppleWebKit/535.19 (HTML, like Gecko) Chrome/18.0.1025.166 Mobile Safari/535.19");
