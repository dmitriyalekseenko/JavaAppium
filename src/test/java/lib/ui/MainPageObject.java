...
public class MainPageObject {
    ...
    public WebElement waitForElementIsVisible(String locator, String error_message, long timeoutInSeconds)
    {
        By by = this.getLocatorByString(locator);
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
        wait.withMessage(error_message + "\n");
    ...
    public boolean isElementLocatedOnTheScreen(String locator)
    {
        ...
        if (Platform.getInstance().isMW()) {
            ...
            Object js_result = JSExecutor.executeScript("return window.pageYOfset");
    ...
    //метод кликает, либо пока не будет ошибки, либо заданное количество раз
